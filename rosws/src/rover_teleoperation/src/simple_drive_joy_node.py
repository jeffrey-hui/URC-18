...
drive_control_left = rospy.Publisher("/drive/left", std_msgs.msg.Float32, queue_size=20)
drive_control_right = rospy.Publisher("/drive/right", std_msgs.msg.Float32, queue_size=20)


def ctrl_curve(val):
    return math.copysign(val, val ** 2)
